...
; (function (w) {
    ...
    Food.prototype.render = function (map) {
        ...
        console.log(+game.score1.innerHTML % 25 == 0 && +game.score1.innerHTML != 0);
    ...
    ; (function (w) {
        ...
        Snake.prototype.render = function (map) {
            ...
            for (var i = 0; i < this.body.length; i++) {
                ...
                div1.style.height = this.height + "px";
                div1.style.position = "absolute";
                div1.style.background = 'url("./img/101.gif") 20px';
    ...
    ; (function (w) {
        ...
        function Game(map, gogogo, stopMove, score1, score2, endBox, rem, norem, username, rank, colorSelect) {
            ...
            this.timeId;
            this.rank = rank;
            this.food = new Food(0, 0, 0, 0, 'url("./img/251.gif") 20px');
